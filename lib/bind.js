  ...
  function extend(target, object, settings, _path) {
    ...
    forEach(Object.getOwnPropertyNames(object), function eachProp(key) {
      ...
      callback = function valueChangeCallback() {
        ...
        if (target && target.__callback && !target.__dirty) {
          target.__callback.call(settings.instance, target);
        }
      };
      ...
      var definition = {
        ...
        set: function (v) {
          ...
          if (settings.ready && typeof v === o && v !== null && !isArray(v) && !v.__callback) {
            ...
            value = extend(new AugmentedArray(callback, settings), v, settings, path);
          } else {
            value = v;
          }
          ...
          if (settings.ready) {
            ...
            settings.deferred.push(callback.bind(target, value, old));
          }
        },
        get: function () {
          return value;
      ...
      if (typeof value === o && value !== null && !isArray(value)) {
        ...
        target[key] = extend(new AugmentedArray(callback, settings), value, settings, path);
