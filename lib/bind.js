...
var Bind = (function Bind(global) {
  ...
  if (!Object.defineProperty) {
    throw new Error('Prerequisite APIs not available: Object.defineProperty');
  }
  ...
  function extend(target, object, settings, _path, parent) {
    ...
    forEach(Object.getOwnPropertyNames(object), function eachProp(key) {
      ...
      var definition = {
        ...
        set: function (v) {
          ...
          if (settings.ready && typeof v === o && v !== null && !Array.isArray(v)) {
            ...
            value = extend(new AugmentedArray(callback, settings), v, settings, path, target);
          } else {
            value = v;
          }
          ...
          var cbwrapper = function initValue(callback, value, old) {
            if (callback) {
              callback.call(target, value, old);
            }

            if (parent && parent.__callback) {
      ...
      if (typeof value === o && value !== null && !Array.isArray(value)) {
        ...
        target[key] = extend(new AugmentedArray(callback, settings), value, settings, path, target[key]);
  ...
  Bind.prototype.__export = function () {
    function extend(target, object) {
      forEach(Object.getOwnPropertyNames(object), function (key) {
        ...
        if (typeof value === o && value !== null && value instanceof AugmentedArray) {
          target[key] = [].slice.call(value, 0);
        } else if (typeof value === o && value !== null && !Array.isArray(value)) {
