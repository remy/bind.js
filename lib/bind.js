...
var Bind = (function Bind(global) {
  ...
  function extend(target, object, settings, _path) {
    ...
    forEach(Object.getOwnPropertyNames(object), function eachProp(key) {
      ...
      var findCallback = function findCallback() {
        var callbacks = [];
        var values = [];
            ...
            if (typeof prev[curr].__callback === 'function') {
              if (instance.__dirty) {
                dirty = {
                  ...
                  values: __export(instance instanceof Array ? [] : {}, instance),
                };
              }

              values.push(__export(instance instanceof Array ? [] : {}, instance));
        ...
        if (!dirty) {
          ...
          dirty.callback.call(settings.instance, dirty.values);
        }
      };
